Building Modastylz API Gateway
=============================
...
> java -classpath ./build/libs/modastylz-api-gateway-0.1-snapshot-fat.jar: -Dvertx.metrics.options.enabled=true -Dvertx.logger-delegate-factory-class-name=io.vertx.core.logging.SLF4JLogDelegateFactory io.vertx.core.Launcher -conf src/main/resources/modastylz-api-gateway.json -cluster -instances 4
